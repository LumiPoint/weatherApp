# Weather App
This is a web app developed as a final project for SheCodes Plus using HTML, CSS, and Vanilla JavaScript. It is hosted on Netlify and utilizes both SheCodes Weather API and OpenWeatherMap API to fetch weather data. The app allows users to search for the weather conditions of any city in the Bangladesh and provides current weather conditions, a 5-day forecast, and hourly forecasts. Additionally, the app can detect the user's current position if they allow it.
Note:The initial codebase was obtained from an open-source MIT licensed project. Further modifications and enhancements were implemented by me.
...
# Demo
A live demo of the weather app can be found at [LINK TO LIVE DEMO](fweather-app.netlify.app).
